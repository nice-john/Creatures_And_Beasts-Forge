...
/**
 * Sword that progressively heats up to imbue tiers (0â€“4). Hitting an enemy ignites them for
 * 2Ã— imbueLevel seconds. Right-clicking while looking at lava replaces the sword with the max-
