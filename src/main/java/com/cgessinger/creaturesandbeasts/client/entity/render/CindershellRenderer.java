...
public class CindershellRenderer extends GeoEntityRenderer<CindershellEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, CindershellEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        super.preRender(poseStack, animatable, model, bufferSource, buffer, isReRender, partialTick, packedLight, packedOverlay, red, green, blue, alpha);
        this.cindershell = animatable;
    }

    @Override
    public void renderRecursively(PoseStack poseStack, CindershellEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
